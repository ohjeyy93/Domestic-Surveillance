...
wholefiles=[]
for subdir, dirs, files in os.walk("justcontrols1"):
    for file in files:
...
wholefiles=[]
for subdir, dirs, files in os.walk("Geneioustable3"):
    for file in files:
        wholefiles+=[os.path.join(subdir, file)]
...
#print(dict1)
with open("testcontrol1.csv", 'w') as t1:
    t1.write("Sample,Gene,SNP,NeST(2.0.0st),NFNeST,Geneious,Control"+"\n")
    for item in dict1:
        #print(item)
