...
for subdir, dirs, files in os.walk("Allreports3"):
    for file in files:
        if "cali" not in subdir and "DS_Store" not in file:
            wholefiles+=[os.path.join(subdir, file)]
        if "cali" in subdir:
...
for subdir, dirs, files in os.walk("Allreports4"):
    for file in files:
        if "cali" not in subdir and "DS_Store" not in file:
            wholefiles+=[os.path.join(subdir, file)]
        if "cali" in subdir:
                        ...
                        for item in dict1:
                            ...
                            if tempdict3[0:2] == item[0:2] and tempdict3[-4:] == item[-4:]:
                                ...
                                for x in a:
                                    if "Major" in x:
                                        tempcount2+=1
                                if tempcount2==1 and len(a)==6:
                                    dict1[item]=dict1[item]+","+tempgene3
                                if tempcount2==2 and len(a)==6:
                                    dict1[item]=dict1[item]+","+tempgene3
                                #print(a.count("Major"))
                                if "Major" not in dict1[item]:
                                    dict1[item]=dict1[item]+","+tempgene3
...
with open("testnew2.csv", 'w') as t1:
    t1.write("Sample,Gene,SNP,NeST(cali),NeST(2.0.0st),NeST(2.0.1),NFNeST,NFNeST(NoCov75%),NFNeST(bbduk1),Geneious,Control"+"\n")
    for item in dict1:
        #print(item)
