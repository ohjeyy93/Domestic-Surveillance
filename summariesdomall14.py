...
#print(dict1)
#print(dict1)
with open("testdomsamfixbp10.csv", 'w') as t1:
    ...
    for item in dict1:
        ...
        if len(list(dict1[item].split(",")))>5:
            print(list(dict4[item].split(","))[0],list(dict4[item].split(","))[1])
            t1.write(dict1[item]+"\n")
            t1.write(item[0:item.find(",")]+",basepos,"+item[item.find(",")+1+item[item.find(",")+1::].find(",")+1::]+","+dict4[item][0:dict4[item].find(",")]+"\n")
            t1.write(item[0:item.find(",")]+",coverage,"+item[item.find(",")+1+item[item.find(",")+1::].find(",")+1::]+","+dict2[item][0:dict2[item].find(",")]+"\n")
            t1.write(item[0:item.find(",")]+",Variant frequency,"+item[item.find(",")+1+item[item.find(",")+1::].find(",")+1::]+","+dict3[item][0:dict3[item].find(",")]+"\n")
        else:
            t1.write(dict1[item]+"\n")
