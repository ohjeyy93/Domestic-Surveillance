...
wholefiles=[]
for subdir, dirs, files in os.walk("Allreports11dom7"):
    for file in files:
...
wholefiles=[]
for subdir, dirs, files in os.walk("geneiousannotationdomall5"):
    for file in files:
        wholefiles+=[os.path.join(subdir, file)]
...
for files in wholefiles:
    with open(files,"r") as f1:
        ...
        countcom1=0
        countcom2=0
        if files!="geneiousannotationdomall5/.DS_Store":
            for lines in f1:
                count=0
                current=""
                templist=""
...
with open("testdomsamfixbp22.csv", 'w') as t1:
       ...
       #         print(dict2[item])
        ...
        if item[-1].isdigit()==True and len(list(dict1[item].split(",")))>=8:
            ...
            if item in dict751 and item in dict752:
                ...
                if "N75E,N75E" in dict1[item]:
                    ...
                    if len(list(dict2[item].split(",")))>5:
                        t1.write(item[0:item.find(",")]+",coverage,"+list(dict1[item].split(","))[2]+","+list(dict2[item].split(","))[1]+","+"NA"+","+"NA"+","+"NA"+","+list(dict2[item].split(","))[2]+"\n")
                    if len(list(dict3[item].split(",")))>5:
                        t1.write(item[0:item.find(",")]+",Variant frequency,"+list(dict1[item].split(","))[2]+","+list(dict3[item].split(","))[1]+","+"NA"+","+"NA"+","+"NA"+","+list(dict3[item].split(","))[2]+"\n")
                    if len(list(dict3[item].split(",")))==5:
                        t1.write(item[0:item.find(",")]+",coverage,"+list(dict1[item].split(","))[2]+","+"NA"+","+"NA"+","+"NA"+","+dict2[item]+"\n")
                    if len(list(dict3[item].split(",")))==5:
                        t1.write(item[0:item.find(",")]+",Variant frequency,"+list(dict1[item].split(","))[2]+","+"NA"+","+"NA"+","+"NA"+","+dict3[item]+"\n")
                    if len(list(dict1[item].split(",")))>8:
                        t1.write(dict1[item][0:-len(list(dict1[item].split(",")[-1]))-1]+"\n")
                    else: t1.write(dict1[item]+"\n")
                    t1.write(item[0:item.find(",")]+",basepos,"+list(dict1[item].split(","))[2]+","+"NA"+","+"NA"+","+"NA"+","+"497,497"+"\n")
                    if len(list(dict2[item].split(",")))>5:
                        t1.write(item[0:item.find(",")]+",coverage,"+list(dict1[item].split(","))[2]+","+list(dict2[item].split(","))[1]+","+"NA"+","+"NA"+","+"NA"+","+list(dict2[item].split(","))[2]+"\n")
                    if len(list(dict3[item].split(",")))>5:
                        t1.write(item[0:item.find(",")]+",Variant frequency,"+list(dict1[item].split(","))[2]+","+list(dict3[item].split(","))[1]+","+"NA"+","+"NA"+","+"NA"+","+list(dict3[item].split(","))[2]+"\n")
            ...
            if item in dict751 and item not in dict752:
                ...
                if len(list(dict1[item].split(",")))>=8:
                    t1.write(dict1[item]+"\n")
                    t1.write(item[0:item.find(",")]+",basepos,"+list(dict1[item].split(","))[2]+","+"NA"+","+"NA"+","+"NA"+","+"NA"+","+dict4[item]+"\n")
                    t1.write(item[0:item.find(",")]+",coverage,"+list(dict1[item].split(","))[2]+","+"NA"+","+"NA"+","+"NA"+","+"NA"+","+dict2[item]+"\n")
                    t1.write(item[0:item.find(",")]+",Variant frequency,"+list(dict1[item].split(","))[2]+","+"NA"+","+"NA"+","+"NA"+","+"NA"+","+dict3[item]+"\n")
                #if "SRR8950840,DHPS,S436" in item:
                #    print(item)
                #    print(dict1[item])
                #    print(dict4[item])
        ...
        #    print(dict1[item])
                ...
                if len(list(dict4[item].split(",")))>5:
                    t1.write(item[0:item.find(",")]+",basepos,"+list(dict1[item].split(","))[2]+","+list(dict4[item].split(","))[-2]+","+"NA"+","+"NA"+","+"NA"+","+list(dict4[item].split(","))[-1]+"\n")
                if len(list(dict2[item].split(",")))>5:
                    t1.write(item[0:item.find(",")]+",coverage,"+list(dict1[item].split(","))[2]+","+list(dict2[item].split(","))[-2]+","+"NA"+","+"NA"+","+"NA"+","+list(dict2[item].split(","))[-1]+"\n")
                if len(list(dict3[item].split(",")))>5:
                    t1.write(item[0:item.find(",")]+",Variant frequency,"+list(dict1[item].split(","))[2]+","+list(dict3[item].split(","))[-2]+","+"NA"+","+"NA"+","+"NA"+","+list(dict3[item].split(","))[-1]+"\n")
                if len(list(dict4[item].split(",")))==5:
                    t1.write(item[0:item.find(",")]+",basepos,"+list(dict1[item].split(","))[2]+","+"NA"+","+"NA"+","+"NA"+","+dict4[item]+"\n")
                if len(list(dict2[item].split(",")))==5:
                    t1.write(item[0:item.find(",")]+",coverage,"+list(dict1[item].split(","))[2]+","+"NA"+","+"NA"+","+"NA"+","+dict2[item]+"\n")
                if len(list(dict3[item].split(",")))==5:
                    t1.write(item[0:item.find(",")]+",Variant frequency,"+list(dict1[item].split(","))[2]+","+"NA"+","+"NA"+","+"NA"+","+dict3[item]+"\n")
