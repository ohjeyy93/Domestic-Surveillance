...
with open("testdomsamfixbp21.csv", 'r') as t1:
    for lines in t1:
...
dict1={}
with open("testdomsamfixbp21.csv", "r") as r1:
    with open("discrepancytestdomsamfixbp169.csv", "w") as r2:
...
with open("discrepancytestdomsamfixbp169.csv", "a") as r2:
...
count=0
with open("discrepancytestdomsamfixbp169.csv", "r") as f2:
    for line in f2:
        if "V73V" in line:
            count+=1
print(count)
