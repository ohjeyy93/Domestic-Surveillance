...
for item in wholecombinedlist1:
    ...
    if "#" in item:
        ...
        dict4[item]=a[0]+","+"basepos"+","+a[2]+","+"NA"+","+wholebplist1f[item]
        dict2[item]=a[0]+","+"coverage"+","+a[2]+","+"NA"+","+wholecovlist1f[item]
        dict3[item]=a[0]+","+"Variant frequency"+","+a[2]+","+"NA"+","+wholevaflist1f[item]
        ...
        if item in dictall2 and item not in wholegenilist1 and item[0:-1] in dictall and item[0:-1] in wholegenilistcut1:
            ...
            if item in dict1f:
                ...
                dict4[item]=a[0]+","+"basepos"+","+a[2]+","+dict4f[item]+","+"NA"
                dict2[item]=a[0]+","+"coverage"+","+a[2]+","+dict2f[item]+","+"NA"
                dict3[item]=a[0]+","+"Variant frequency"+","+a[2]+","+dict3f[item]+","+"NA"
            #if "SRR6463643,PfCRT,M74I" in item:
            #    print(dict1[item])
            #    print(dict4[item])
            #    print(dict2[item])
...
with open("testdomsamfixbp21.csv", 'w') as t1:
    ...
    for item in dict1:
        ...
        #    print(dict1[item])
        #print(item)
        if item[-1].isdigit()==True and len(list(dict1[item].split(",")))>=5:
            #if len(list(dict1[item].split(",")))<5:
            #    print("stranger")
            #    print(dict1[item])
        ...
        #    print(dict1[item])
                ...
                if len(list(dict3[item].split(",")))==2:
                    t1.write(item[0:item.find(",")]+",Variant frequency,"+list(dict1[item].split(","))[2]+","+dict3[item]+"\n")
        ####################################problem flag ##########################################
        if item[-1].isdigit()==False and len(list(dict1[item].split(",")))>=5:
            #if len(list(dict1[item].split(",")))<5:
            #    print("weirdo")
            #    print(dict1[item])
            #print(item) 
