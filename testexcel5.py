...
with open("formatnew2.csv", 'w') as t1:
...
wholefiles=[]
for subdir, dirs, files in os.walk("Allreports11dom1"):
    for file in files:
                        ...
                        for item in wholelist1:
                            ...
                            #print(tempgene1)
                                if item not in dict1:
                                    ...
                                    #print(tempgene1)
                                    #print(tempgene1)
                                    if tempcov!="NA" and int(tempcov)>0:
                                        dict1[item]=","+tempgene1
                                        #print(tempvafaf1)
                                        dict2[item]=tempvafdp1
                                        dictwd[item]="WT"
                                        break
    ...
    for item2 in list1:
        ...
        if item2!="None":
            if (item,item2) in dict3:
                ...
                #print(dict3[item,dict6[item]])
                if dict3[item,dict6[item]]!="None":
                    dict4[item]=dict4[item]+","+str(float(dict3[item,dict6[item]])*100)+"%"
                if dict3[item,dict6[item]]=="None":
                    dict4[item]=dict4[item]+","+" "
            else:
                #print(dict4[item])
                if dictwd2[item,dict6[item]] == "WT":
...
for item in sortednames:
    ...
    #print(dict4[])
    with open("formatnew2.csv", 'a') as t1:
        writer = csv.writer(t1)
