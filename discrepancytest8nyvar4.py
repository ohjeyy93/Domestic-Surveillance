...
with open("testdomsamfixbp24nyfb.csv", "r") as r1:
    with open("discrepancytestdomsamfixbp173nyfbrev.csv", "w") as r2:
        ...
        for line in r1:
            ...
            #print(list(line.split(",")))
                ...
                #print(a[-1])
                #print(a[-5])
                if a[1]!="Variant frequency" and a[1]!="coverage" and a[1]!="basepos" and a[-5]!="NA" and a[-5]!="WT":
                    #print(a)
                    if a[-5]+"\n"!=a[-1]:
                        r2.write(line)
                        testcount+=1
...
count=0
with open("discrepancytestdomsamfixbp173nyfbrev.csv", "r") as f2:
    for line in f2:
        if "V73V" in line:
            count+=1
print(count)
