...
wholefiles=[]
for subdir, dirs, files in os.walk("Allreports11dom8nyfb"):
    for file in files:
        ...
        if item[-1].isdigit()==True and len(list(dict1[item].split(",")))>=8:
            ...
            #    print(dict1[item])
                ...
                if len(list(dict1[item].split(",")))>8:
                    ...
                    t1.write(dict1[item]+"\n")
                    #print(dict4[item])
                    #print(len(dict4[item]))
                    #print(dict2[item])
                    #print(dict3[item])
                    #if "19ANZa00F0031PfFxxx0_S67_L001" in item:
                    #    if "N75" in item:
                    #print(dict1[item])
                    if len(dict4[item].split(","))>5:
                        t1.write(item[0:item.find(",")]+",basepos,"+list(dict1[item].split(","))[2]+","+list(dict4[item].split(","))[3]+","+list(dict4[item].split(","))[4]+","+list(dict4[item].split(","))[5]+","+list(dict4[item].split(","))[6]+","+list(dict4[item].split(","))[7]+"\n")
                        t1.write(item[0:item.find(",")]+",coverage,"+list(dict1[item].split(","))[2]+","+list(dict2[item].split(","))[3]+","+list(dict2[item].split(","))[4]+","+list(dict2[item].split(","))[5]+","+list(dict2[item].split(","))[6]+","+list(dict2[item].split(","))[7]+"\n")
                        t1.write(item[0:item.find(",")]+",Variant frequency,"+list(dict1[item].split(","))[2]+","+list(dict3[item].split(","))[3]+","+list(dict3[item].split(","))[4]+","+list(dict3[item].split(","))[5]+","+list(dict3[item].split(","))[6]+","+list(dict3[item].split(","))[7]+"\n")
                    if len(dict4[item].split(","))<=5:
