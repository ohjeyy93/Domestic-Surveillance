...
wholefiles=[]
for subdir, dirs, files in os.walk("Allreports11dom4"):
    for file in files:
                    ...
                    for word in lines.split(","):
                        ...
                        if count==20:
                            ...
                            if word!="":
                                ...
                                if "GAA" in lines and "497" in lines and "N -> E" in lines:
                                    #print(templist)
                                    #print(list(templist.split(","))[-1])
...
with open("testdomsamfixbp15.csv", 'w') as t1:
