    ...
    with open(files,"r") as f1:
        ...
        for lines in f1:
            ...
            if tempdict1!="":
                ...
                #print(tempvafdp1)
                if tempvafdp1!="NA":
                    dict3[item]=str(float(tempvafdp1)*100)+"%"
                    dictvar[item]=str(float(tempvafdp1)*100)+"%"
                if tempvafdp1=="NA":
            ...
            for lines in f1:
                ...
                if tempword!="" and len(templist.split(","))>2:
                    ...
                    if tempword[0:2]=="MN" and tempword[-2::]=="IE":
                        ...
                        wholetypelist1[templist]=templist[templist.find(",")+1+templist[templist.find(",")+1::].find(",")+1::]
...
for item in wholecombinedlist1:
    ...
    if item in dict1 and item in wholegenilist1:
        ...
        dict1[item]=dict1[item]+","+wholetypelist1[item]
...
#print(dict1)
with open("testdomsamfixbp6.csv", 'w') as t1:
